...
export function Hero() {
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none relative z-[1] -mr-4 sm:-mr-6 lg:-mr-8 after:absolute after:inset-x-[-20px] after:bottom-[-5px] after:h-[48px] after:bg-gradient-to-b after:from-transparent after:to-background max-xl:relative max-xl:inset-x-0 max-xl:h-[300px] max-xl:w-full"
      >
        <OptimizedImage
          alt=""
